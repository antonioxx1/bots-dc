    ...
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)) {
        ...
        if (canal_formulario.type !== Discord.ChannelType.GuildText) {
            ...
            interaction.reply({ embeds: [embed], ephemeral: true }).then( () => {
                ...
                .setTitle(`Formulário:`)
                .setDescription(`Faça seu formulário clicando no botão abaixo! Tempo de resposta: 7 dias. Não peça para lerem o formulário, com isso você será desclassificado do formulário!`);
